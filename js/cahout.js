...
e.preventDefault()
const inputValue=getvalueFrominputfield('cashout-amount')
const pin=getvalueFrominputfield('cashout-pin')
const bankAC=getvalueFrominputfield('input-num2')
if(isNaN(inputValue)){
...
div.innerHTML=`
<div class="mt-2"> 
<h3 class="font-semibold text-lg "> Cash out </h3>
